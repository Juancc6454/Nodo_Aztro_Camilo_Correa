...
public class AgenciaDeViajes {
    public static void main(String[] args) {
        ...
        Administrador administrador = new Administrador(2, "Juan", "Velez", "1985-11-10", "Avenida Unica", "555-1116");
        GestorDeViajes gestor = new GestorDeViajes(3, "Isabel", "Rave", "1998-10-15", "Boulevard del Sol", "555-1202");
